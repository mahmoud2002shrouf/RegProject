...
from .views import search_courses, get_course_by_id, add_course_schedule, get_all_course_schedules, add_course, get_all_courses, Login, Register, logout, register_course_for_student, get_student_courses, get_courses_with_completed_prerequisites, get_recent_courses
...
urlpatterns = [
    ...
    path('register/', register_view, name='register'),  # T
    path('login/', login_view, name='login'),  # T
